          ...
          <div class="sidebar mb-0">
            <div class="widget">
              ...
              <div class="widget-content">
                ...
                ?>
                <!-- No action, no method: only JS fetch to save-listing.php -->
                <form
                  id="addListingForm"
                ...
                >
                  ...
                  <div class="mb-3 col-lg-6 select-border">
                    ...
                    <select class="form-control" name="category" required>
                      <?php
                        $stmtCat = $pdo->query("SELECT name FROM categories WHERE type = 'food'");
                  ...
                  <div class="widget mt-3 w-100">
                    ...
                    <div class="widget-content">
                      <div class="row align-items-end">
                        ...
                        <!-- No separate "Save & Preview" button, just the final one below -->
                      </div>
                    </div>
                  </div>
