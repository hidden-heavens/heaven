  ...
  <div class="container">
    <div class="row align-items-center justify-content-center">
      <!-- <div class="col-lg-6 col-md-6 mb-lg-0 mb-5">
         <img class="img-fluid" src="images/error-404/01.svg" alt="">
      </div> -->
      <div class="col-lg-10 col-md-8 mt-4 mt-sm-0 text-center">
        <div id="notfound">
          <div class="notfound">
            <img class="img-fluid" src="images/error-404/404.jpg" alt="">
            ...
            <a class="btn btn-primary" href="index.html">Go To Homepage</a>
          </div>
        </div>
      </div>
    </div>
