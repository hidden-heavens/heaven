...
<header class="header">
    <nav class="navbar navbar-static-top navbar-expand-lg header-sticky">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">listing details <i class="fas fa-chevron-right fa-xs"></i></a>
                    <ul class="dropdown-menu">
        ...
        <li class="nav-item dropdown active">
          <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            User panel <i class="fas fa-chevron-down fa-xs"></i>
          </a>
          <ul class="dropdown-menu">
            <li class="active"><a class="dropdown-item" href="dashboard.html">dashboard</a></li>
    ...
    <div class="call d-block d-md-flex align-items-center">
      <div class="login d-inline-block me-4">
        <a class="text-white" data-bs-toggle="modal" data-bs-target="#loginModal" href="#"><i class="fa fa-user pe-2 text-primary"></i>Hello sign in</a>
      </div>
    ...
    <div class="row position-relative">
      <div class="col-lg-6">
        <div class="d-flex align-items-center">
          <img class="img-fluid rounded-circle avatar avatar-xll" src="images/avatar/01.jpg" alt="">
          <div class="ms-4">
            <h3 class="text-white mb-2"> Alice Williams</h3>
            <div class="d-flex">
              <span class="d-inline-block text-white">The first thing to remember about success.</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="widget">
            ...
            <div class="widget-content dashboard-nav">
              <ul class="list-unstyled">
                <li class="active"><a href="#"> <i class="fas fa-home me-2"></i> Dashboard</a></li>
                <li><a href="dashboard-message.html"> <i class="far fa-comment-alt me-2"></i> Message</a></li>
                <li><a href="dashboard-chat.html"> <i class="far fa-comments me-2"></i> Chat</a></li>
                <li><a href="dashboard-my-profile.html"> <i class="far fa-user me-2"></i> My Profile</a></li>
              </ul>
      ...
      <div class="col-lg-9 col-md-8">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 mb-4">
            <div class="bg-white p-4 shadow-sm border-radius">
              <h5 class="mb-4">Listings activity</h5>
              <ul class="activity">
                <li class="activity-item primary">
                  ...
                  <div class="activity-info">
                    <h6 class="mb-0">Alice Williams left a review. </h6>
                ...
                <li class="activity-item info">
                  ...
                  <div class="activity-info">
                    <h6 class="mb-0">The car listing has been approved!</h6>
                    <span>
                      Fri, 20 Jan
                    </span>
                  </div>
                ...
                <li class="activity-item danger">
                  ...
                  <div class="activity-info">
                    <h6 class="mb-0"> Assign a task for Smith.  </h6>
                    <span>
                      Wed, 23 Mar
                    </span>
                  </div>
                ...
                <li class="activity-item warning">
                  ...
                  <div class="activity-info">
                    <h6 class="mb-0">Job listing has been approved!</h6>
                    <span>12:00</span>
                  </div>
                </li>
                <li class="activity-item info">
                  ...
                  <div class="activity-info">
                    <h6 class="mb-0"> Meeting with the CEO.</h6>
                    <span>
                      Thu, 25 June
                    </span>
                  </div>
            ...
            <div class="listing-item">
                  <div class="listing-image bg-overlay-half-bottom">
                    ...
                    <div class="listing-quick-box">
                        ...
                        <a class="popup popup-single" href="images/listing/grid/01.jpg" data-bs-toggle="tooltip" data-placement="top" aria-label="Zoom"> <i class="fas fa-search-plus"></i> </a>
                        <a class="like" href="#" data-bs-toggle="tooltip" data-placement="top" aria-label="Like"> <i class="far fa-heart"></i> </a>
                    </div>
                  ...
                  <div class="listing-details">
                    <div class="listing-details-inner">
                      ...
                      <p class="mb-3">Let success motivate you. Find a picture of what epitomizes success to you.</p>
...
<!--=================================
footer-->
<footer class="footer space-pt bg-overlay-black-80" style="background-image: url(images/map-bg.png);background-color: #000;background-position: left top;background-repeat: no-repeat;width: 100%;">
